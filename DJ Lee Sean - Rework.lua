...
function Insec:IsReady(tar)
    return (((W.IsReady() and ward:IsReady()) or Flash.IsReady()) and R.IsReady()) and self:BestPos(tar)~=nil
end
...
function Insec:RecentInsec()
    return os.clock() - ward.lastTimeWard < 0.5 or os.clock() - Flash.LastCastTime < 0.5
end
